  ...
  <div class="container my-60">
    ...
    <div class="flex flex-wrap -mx-2">
      <div v-if="items.length>0">
        <si-carousel v-if="$settings.sections.posts.active" component="si-post" :title="$settings.sections.posts.title" :list="items" :mobile_size="this.mobile_size ? this.mobile_size : 100"></si-carousel>
      </div>
    </div>
    ...
    <div class="flex justify-center mt-8" v-if="$settings.sections.posts.show_more_text">
      <nuxt-link class="py-3 px-6 bg-primary text-white shadow-lg rounded-full hover:bg-primary-dark transition duration-300 flex items-center" to="/blog">
        <span class="w-full text-center">{{ $settings.sections.posts.show_more_text }}</span>
