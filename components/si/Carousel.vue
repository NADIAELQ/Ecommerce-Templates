<template>
  <div class="container relative">
    <div class="absolute left-0 top-1/2 transform -translate-y-1/2 z-40">
      <button class="circle-button" id="prv" title="prv" @click="move(-1)">
    ...
    <div class="absolute right-0 top-1/2 transform -translate-y-1/2 z-40">
      <button class="circle-button" id="next" title="next" @click="move(1)">
    ...
    <div class="m-2 flex justify-between items-center">
      <h2 class="text-4xl font-serif text-black uppercase">{{ this.title }}</h2>
    </div>
